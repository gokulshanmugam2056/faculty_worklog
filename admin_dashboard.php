...
include 'admin_header.php'; // <-- header included here
include 'db.php';
...
<head>
    ...
    <style>
        ...
        h1 { font-size: 20px; color: #333; margin-bottom: 14px; }
        table { width: 100%; border-collapse: collapse; background: white; border-radius: 8px; overflow: hidden; box-shadow: 0 2px 6px rgba(0,0,0,0.05); font-size: 13px; }
        th, td { padding: 8px 10px; border-bottom: 1px solid #ddd; text-align: left; }
        th { background-color: #828794ff; color: white; }
        tr:hover { background-color: #f9f9f9; }
        .status { font-weight: 600; }
        .Approved { color: green; }
        .Rejected { color: red; }
        .Pending { color: orange; }
        select, input[type="text"] { padding: 4px 6px; font-size: 12px; border-radius: 4px; border: 1px solid #ccc; max-width: 120px; }
        .submit-btn { padding: 5px 10px; border: none; background-color: #4CAF50; color: white; border-radius: 4px; cursor: pointer; font-size: 12px; }
        .edit-icon { font-size: 13px; text-decoration: none; color: #e67e22; }
